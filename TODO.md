...
- [ ] **Status review 2026-09-04, after four days unattended.** Working: the hourly
  ...
  * Disk: index 20 GB, archive 5.2 GB plus one 5.2 GB backup, the retired mini memstore copy
    28 GB at `~/.local/share/memstore-peer-b-retired-20260904/`, and the volume is at 94%.
